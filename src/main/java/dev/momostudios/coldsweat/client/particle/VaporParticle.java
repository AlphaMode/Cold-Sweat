...
public class VaporParticle extends SpriteTexturedParticle
{
    ...
    protected VaporParticle(ClientWorld world, double x, double y, double z, double vx, double vy, double vz, IAnimatedSprite spriteSet, boolean gravity)
    {
        super(world, x, y, z);
    ...
    public static class SteamFactory implements IParticleFactory<BasicParticleType>
    {
        ...
        public Particle makeParticle(BasicParticleType typeIn, ClientWorld worldIn, double x, double y, double z, double xSpeed, double ySpeed, double zSpeed) {
            if (Minecraft.getInstance().gameSettings.particles != ParticleStatus.MINIMAL)
                return new VaporParticle(worldIn, x, y, z, xSpeed, ySpeed, zSpeed, this.sprite, false);
            else
                return null;
        }
    }
    ...
    public static class MistFactory implements IParticleFactory<BasicParticleType>
    {
        ...
        public Particle makeParticle(BasicParticleType typeIn, ClientWorld worldIn, double x, double y, double z, double xSpeed, double ySpeed, double zSpeed) {
            ...
            if (status != ParticleStatus.MINIMAL && status != ParticleStatus.DECREASED)
                return new VaporParticle(worldIn, x, y, z, xSpeed, ySpeed, zSpeed, this.sprite, true);
            else
                return null;
        }
    }
