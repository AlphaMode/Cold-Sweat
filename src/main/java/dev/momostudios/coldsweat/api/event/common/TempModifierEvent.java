...
public class TempModifierEvent extends Event
{
    ...
    public static class Add extends TempModifierEvent
    {
        ...
        public Add(TempModifier modifier, PlayerEntity player, Temperature.Types type, int maxCount)
        {
    ...
    public static class Remove extends TempModifierEvent
    {
        ...
        public Remove(PlayerEntity player, Temperature.Types type, int count, Predicate<TempModifier> condition)
        {
            this.player = player;
            this.type = type;
            this.count = count;
