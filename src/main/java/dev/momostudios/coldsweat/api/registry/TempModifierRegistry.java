...
public class TempModifierRegistry
{
    ...
    public static void register(TempModifier modifier)
    {
        if (TEMP_MODIFIERS.containsKey(modifier.getID()))
        {
            ...
            ColdSweat.LOGGER.error("{} ({})", modifier.getClass().getName(), modifier.getID());
            ColdSweat.LOGGER.error("{} ({})", TEMP_MODIFIERS.get(modifier.getID()).getClass().getName(), modifier.getID());
     ...
     */
    public static TempModifier get(String id)
    {
        try
        {
